...
CVA5 is a 32-bit RISC-V processor designed for FPGA implementations, supporting RV32IMAFD according to its README. It is derived from the Taiga project and uses a configurable 5-stage-style architecture with parallel, variable-latency execution units; OpenHW lists CVA5 as completed.
