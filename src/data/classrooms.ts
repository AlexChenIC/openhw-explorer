    ...
    lessons: [
      {
        ...
        summary: {
          en: "Decode CVE2, CV32E20, CV32E40P/X/S, CVA6, and current CVA6 configurations while distinguishing families, repositories, named cores, releases, and identity CSRs.",
          zh: "拆解 CVE2、CV32E20、CV32E40P/X/S、CVA6 及其当前配置，并区分家族、仓库、具名内核、发布版本和身份 CSR。",
        },
        outcome: {
          en: "Use a CORE-V name to locate the correct code base and manual, then verify the implementation through its configuration, release, and identity CSRs.",
          zh: "利用 CORE-V 名称定位正确的代码库与手册，再通过配置、发布版本和身份 CSR 核实具体实现。",
        },
        tags: ["OpenHW", "CORE-V", "CVE2", "CV32E20", "CVA6", "nomenclature"],
        sourceRefs: [
          "CORE-V family catalog",
      ...
      },
      {
        ...
        summary: {
          en: "Separate RISC-V standards, Eclipse governance, OpenHW programme direction, CORE-V processor IP, and the repositories that carry implementation evidence.",
          zh: "区分 RISC-V 标准、Eclipse 治理、OpenHW 协作方向、CORE-V 处理器 IP，以及承载实现证据的项目仓库。",
        },
        outcome: {
          en: "Route an architecture, governance, implementation, or verification question to a source with the right authority and scope.",
          zh: "面对架构、治理、实现或验证问题时，能够找到权限范围与问题相匹配的一手资料。",
        },
        tags: ["OpenHW Foundation", "Eclipse Foundation", "RISC-V", "CORE-V", "governance"],
        sourceRefs: [
          "OpenHW Foundation: About",
          "OpenHW Foundation Charter v1.1",
