    ...
    lessons: [
      {
        ...
        classroomId: "openhw-cva6-u01-l01-what-is-cva6-zh",
        projectId: "cva6",
        ...
        title: {
          en: "What is CVA6: do not rush into RTL",
      ...
      },
      {
        ...
        classroomId: "openhw-cva6-architecture-map-zh",
        projectId: "cva6",
        seriesId: "cva6-from-zero",
        status: "pilot",
        order: 5,
      ...
      {
        id: "cva6-slidekit-a1",
        classroomId: "openhw-cva6-slidekit-a1-zh",
        projectId: "cva6",
        seriesId: "cva6-from-zero",
        status: "draft",
        order: 0,
