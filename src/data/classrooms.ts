...
export const classroomSeries: ClassroomSeries[] = [
  {
    ...
    skills: [
      ...
      },
      {
        ...
        description: {
          en: "A planned checkpoint for issue ordering, scoreboard state, data hazards, forwarding, and structural pressure.",
          zh: "计划用于检查 issue ordering、scoreboard state、data hazards、forwarding 和 structural pressure。",
        },
        lessonIds: [],
      },
    ],
